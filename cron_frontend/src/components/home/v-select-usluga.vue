    ...
    <div v-if="show" class="modal-shadow" @click.self="closeModal">
        <div class="modal">
            ...
            <div class="modal__usluga">
                ...
                >
                    <input v-model="selectedUsluga" hidden :value="parentUsluga" :key="index" name="usluga" id="usluga" type="radio">
                    <span class="home__mid__cart-big">{{ parentUsluga.spesialist }}</span>
                </label>
            </div>
            <!-- <slot name="footer">
