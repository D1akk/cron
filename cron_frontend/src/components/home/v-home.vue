        ...
        <div class="home-top">
            <div class="container">
                ...
                <div class="home-top__grid">
                    ...
                    <SelectUsluga :parentUslugas="uslugas" v-model="selectedUsluga" ref="modalUsluga"></SelectUsluga>
                </div>
            </div>
        </div>
        <div class="home__mid">
            <div class="container">
                <p class="home__mid-p">
                    Свободные окна к специалистам в этот день
                </p>
                <div class="home__mid__grid">
                    ...
                    >
                        <input v-model="selectedOption" hidden :value="time.hour" :key="index" name="time" id="time" type="radio">
...
<style>
    ...
    .home__bottom__cart.aksii, .home__bottom__cart.aksii span{
        color: white;
    }
</style>