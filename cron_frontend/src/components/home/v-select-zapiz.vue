<template>
    <div v-if="show" class="modal-shadow" @click.self="closeModal">
        <div class="modal-zapiz">
            ...
            <div v-for="(klinic, index) in klinics" :key="index" class="modal__zapiz">
                <span class="modal__zapiz-name">{{ klinic.name }}</span>
                ...
                <div class="gwegwegwegwegfw">
                    <span class="modal__zapiz-street">{{ klinic.street }}</span>
                ...
                <span class="modal__zapiz-info">{{ klinic.info }}</span>
